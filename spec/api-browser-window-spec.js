  ...
  describe('window states (excluding Linux)', () => {
    ...
    describe('kiosk state', () => {
      ...
      it('can be changed with setKiosk method', (done) => {
        ...
        execSync('screencapture ~/project/screen/test179a.png')
        w.once('enter-full-screen', () => {
          execSync('screencapture ~/project/screen/test179b.png')
          console.log('We have entered full screen')
          w.setKiosk(false)
          assert.equal(w.isKiosk(), false)
        })
        w.once('leave-full-screen', () => {
          execSync('screencapture ~/project/screen/test179c.png')
    ...
    describe('fullscreen state with resizable set', () => {
      ...
      it('resizable flag should be set to true and restored', (done) => {
        ...
        w.once('enter-full-screen', () => {
          execSync('screencapture ~/project/screen/test180a.png')
          console.log('We have entered full screen')
          assert.equal(w.isResizable(), true)
          w.setFullScreen(false)
        })
        w.once('leave-full-screen', () => {
          execSync('screencapture ~/project/screen/test180b.png')
          console.log('We have left full screen')
          assert.equal(w.isResizable(), false)
          done()
        })
        ...
        execSync('screencapture ~/project/screen/test180c.png')
